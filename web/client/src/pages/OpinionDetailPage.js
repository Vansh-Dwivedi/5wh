    ...
    <>
      <Helmet>
        ...
        {opinion.featuredImage && (
          <meta property="og:image" content={`http://5whmedia.com${opinion.featuredImage}`} />
        )}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={opinion.title} />
        <meta name="twitter:description" content={opinion.excerpt} />
        {opinion.featuredImage && (
          <meta name="twitter:image" content={`http://5whmedia.com${opinion.featuredImage}`} />
        )}
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            ...(opinion.featuredImage && {
              "image": `http://5whmedia.com${opinion.featuredImage}`
            })
          })}
        </script>
      </Helmet>
