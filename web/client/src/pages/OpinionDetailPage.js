...
const OpinionDetailPage = () => {
  ...
  const fetchOpinion = async () => {
    try {
      setLoading(true);
      const response = await fetch(`https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com/api/opinions/${slug}`);
    ...
    <>
      <Helmet>
        ...
        {opinion.featuredImage && (
          <meta property="og:image" content={`https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com${opinion.featuredImage}`} />
        )}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={opinion.title} />
        <meta name="twitter:description" content={opinion.excerpt} />
        {opinion.featuredImage && (
          <meta name="twitter:image" content={`https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com${opinion.featuredImage}`} />
        )}
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            ...(opinion.featuredImage && {
              "image": `https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com${opinion.featuredImage}`
            })
          })}
        </script>
      </Helmet>
