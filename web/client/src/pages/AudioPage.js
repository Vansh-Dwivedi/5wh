                  ...
                  <Box sx={{ position: 'relative' }}>
                    {podcast.thumbnail?.url ? (
                      <CardMedia
                        component="img"
                        height="200"
                        image={`https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com:5000${podcast.thumbnail.url}`}
                    ...
                    {podcast.audioUrl && (
                      <Box sx={{ mb: 2 }}>
                        ...
                        >
                          ...
                          <source src={`https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com:5000${podcast.audioUrl}`} type="audio/mp4" />
