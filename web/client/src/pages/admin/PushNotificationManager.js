...
const PushNotificationManager = () => {
  ...
  const handleTestNotification = async () => {
    ...
    try {
      const response = await fetch('http://5whmedia.com/api/notifications/push-notification-test', {
        method: 'POST',
        headers: {
  ...
  const handleSendNotification = async () => {
    ...
    try {
      const response = await fetch('http://5whmedia.com/api/notifications/push-notification', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
