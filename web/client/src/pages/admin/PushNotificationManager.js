...
const PushNotificationManager = () => {
  ...
  const handleTestNotification = async () => {
    ...
    try {
      const response = await fetch('https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com:5000/api/notifications/push-notification-test', {
        method: 'POST',
        headers: {
  ...
  const handleSendNotification = async () => {
    ...
    try {
      const response = await fetch('https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com:5000/api/notifications/push-notification', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
