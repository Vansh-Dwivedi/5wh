              ...
              <article>
                ...
                <Box sx={{ mb: 4 }}>
                  {article.featuredImage && article.featuredImage.url ? (
                    <>
                      <img
                        src={article.featuredImage.url.startsWith('http') ? article.featuredImage.url : `http://5whmedia.com${article.featuredImage.url}`}
                      ...
                      >
                        {relatedArticle.featuredImage && relatedArticle.featuredImage.url ? (
                          <CardMedia
                            component="img"
                            height="140"
                            image={relatedArticle.featuredImage.url.startsWith('http') ? relatedArticle.featuredImage.url : `http://5whmedia.com${relatedArticle.featuredImage.url}`}
