              ...
              <article>
                ...
                <Box sx={{ mb: 4 }}>
                  {article.featuredImage && article.featuredImage.url ? (
                    <>
                      <img
                        src={article.featuredImage.url.startsWith('http') ? article.featuredImage.url : `https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com:5000${article.featuredImage.url}`}
                      ...
                      >
                        {relatedArticle.featuredImage && relatedArticle.featuredImage.url ? (
                          <CardMedia
                            component="img"
                            height="140"
                            image={relatedArticle.featuredImage.url.startsWith('http') ? relatedArticle.featuredImage.url : `https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com:5000${relatedArticle.featuredImage.url}`}
