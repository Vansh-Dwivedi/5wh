...
async function testLifeCultureAPI() {
  try {
    ...
    const booksResponse = await axios.get('https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com:5000/api/lifeculture/books');
    ...
    const eventsResponse = await axios.get('https://ec2-16-52-123-203.ca-central-1.compute.amazonaws.com:5000/api/lifeculture/cultural-events');
