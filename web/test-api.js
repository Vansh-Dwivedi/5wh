...
async function testLifeCultureAPI() {
  try {
    ...
    const booksResponse = await axios.get('http://localhost:5000/api/lifeculture/books');
    ...
    const eventsResponse = await axios.get('http://localhost:5000/api/lifeculture/cultural-events');
